...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "contact.phone": { fr: "Numéro de téléphone / WhatsApp", en: "Phone Number / WhatsApp" },
  "contact.phone.ph": { fr: "+33 6 12 34 56 78", en: "+1 555 123 4567" },
  "contact.phone.help": { fr: "Indique ton numéro avec l'indicatif de ton pays (WhatsApp si possible).", en: "Include your country code (WhatsApp if possible)." },
  ...
  "apply.phone": { fr: "Numéro de téléphone / WhatsApp", en: "Phone Number / WhatsApp" },
  "apply.phone.ph": { fr: "+33 6 12 34 56 78", en: "+1 555 123 4567" },
  "apply.phone.help": { fr: "Indique ton numéro avec l'indicatif de ton pays (WhatsApp si possible).", en: "Include your country code (WhatsApp if possible)." },

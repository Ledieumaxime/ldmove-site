      ...
      <SectionWrapper className="bg-sand pt-28 md:pt-36 min-h-[70vh] flex items-center">
        ...
        >
          <h1 className="font-heading text-4xl md:text-5xl font-bold mb-8">
            Middle Split Program : Coming soon
          </h1>
          <p className="font-body text-muted-foreground text-lg leading-relaxed mb-4">
            This middle split program is not available yet. I'm currently building it with my first clients so it's progressive and realistic for busy adults.
          </p>
...
export default MiddleSplitComingSoon;
